...
from data_loader_dnet import get_dataloader
import timm
...
def train_model(model_name, data_dir, num_classes, num_epochs, batch_size, pretrained_path=None, learning_rate=0.0003, checkpoint_path='densenet_checkpoints'):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train DenseNet-201')
    parser.add_argument('--model_name', default='densenet201', help='Timm model name')
    parser.add_argument('--data_dir', required=True, help='Dataset path')
    parser.add_argument('--num_classes', type=int, default=2)
    parser.add_argument('--num_epochs', type=int, default=50)
    parser.add_argument('--batch_size', type=int, default=16)
    parser.add_argument('--learning_rate', type=float, default=0.0003)
    parser.add_argument('--checkpoint_path', default='densenet_checkpoints')
