...
from data_loader_rn101 import get_dataloader
import timm
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train ResNet101')
    parser.add_argument('--model_name', default='resnet101', help='Timm model name')
    parser.add_argument('--data_dir', required=True, help='Dataset path')
    parser.add_argument('--num_classes', type=int, default=2)
    parser.add_argument('--num_epochs', type=int, default=50)
    parser.add_argument('--batch_size', type=int, default=16)
    parser.add_argument('--learning_rate', type=float, default=0.0001)
    parser.add_argument('--checkpoint_path', default='resnet_checkpoints')
